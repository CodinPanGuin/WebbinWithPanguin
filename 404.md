  ...
  document.querySelector('a[href="#g"]').addEventListener("click", (e) => {
    ...
    rollButton.addEventListener("click", (e) => {
      ...
      if (playerpoinsts > dealerpoinsts) {
        console.log("Player points: " + playerpoinsts);
        console.log("Are more than");
        console.log("Dealer points: " + dealerpoinsts);
        pWins = pWins + 1;
      } else if (playerpoinsts < dealerpoinsts) {
        console.log("Player points: " + playerpoinsts);
        console.log("Are less than");
        console.log("Dealer points: " + dealerpoinsts);
        dWins = dWins + 1;
      } else if (playerbonus > dealerbonus) {
        console.log("Player bonus: " + playerbonus);
        console.log("Are more than");
        console.log("Dealer bonus: " + dealerbonus);
